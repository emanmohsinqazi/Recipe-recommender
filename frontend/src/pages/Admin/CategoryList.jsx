    ...
    <div className="min-h-screen py-8 px-4" style={{ background: "linear-gradient(to right, #bfdbfe, #e9d5ff)" }}>
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 mb-6 shadow-lg">
          <h1 className="text-xl font-bold text-gray-800 text-center">Manage Categories</h1>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 text-center">Available Categories</h2>
