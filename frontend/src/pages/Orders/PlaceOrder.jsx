...
import { useCreateOrderMutation, usePayOrderMutation } from "../../redux/api/orderApiSlice"
  ...
  const placeOrderHandler = async () => {
    ...
    try {
      ...
      const paymentDetails = {
        ...
        email_address: userInfo?.email || paymentData.payer?.email_address || "customer@example.com",
      }
      ...
      toast.update(toastId, {
        render: "Order placed and paid successfully! Redirecting to order details...",
        type: "success",
        isLoading: false,
        autoClose: 3000,
      })
      ...
      toast.update(toastId, {
        render:
          error?.data?.message || error.message || "An error occurred while placing your order. Please try again.",
        type: "error",
        isLoading: false,
        autoClose: 5000,
      })
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mt-8">
                  ...
                  <tbody className="divide-y">
                    {cart.cartItems.map((item, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-gray-800">${(item.qty * item.price).toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between pt-2">
                  ...
                  <span className="font-bold text-gray-800 text-lg">${cart.totalPrice}</span>
                </div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-800 mb-3">Shipping</h2>
              ...
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-800 mb-3">Payment Method</h2>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <p className="text-gray-700">
              ...
              <button
                ...
                disabled={cart.cartItems.length === 0 || isLoading || isLoadingPayment}
                onClick={placeOrderHandler}
              >
                {isLoading || isLoadingPayment ? (
                  <>
                    <Loader sm /> {isLoadingPayment ? "Processing Payment..." : "Processing Order..."}
                  </>
                ) : (
                  "Place Order & Pay"
                )}
